...
public class HomeScreen extends GuiScreen {
    ...
    @Override
    public void init() {
        addWidget(new ParticleWidget(150));
        addWidget(new Label(Sandbox.WIDTH / 2, 80, "Sandbox", "Robotto", 200));
        addWidget(
            new Button(Sandbox.WIDTH / 2, (Sandbox.HEIGHT / 2) - 60, 200, "Play", Button.ICON_CHECK,
                this::onClickPlay));
        addWidget(new Button(Sandbox.WIDTH / 2, (Sandbox.HEIGHT / 2) - 10, 200, "Exit",
            Button.ICON_CIRCLED_CROSS, button -> System.exit(0)));
        addWidget(new Checkbox(Sandbox.WIDTH / 2, (Sandbox.HEIGHT / 2) + 110, 20, 20, "Agree",
            rgb(64, 0, 64)));
